...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf starter-node-angularr-temp && mkdir hstarter-node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir starter-node-angular && cp -r starter-node-angular-temp/* hstarter-node-angular/ && rm -rf starter-node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd hstarter-node-angular && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
